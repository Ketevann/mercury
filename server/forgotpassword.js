...
const Token = db.model('passwordtoken')
const bcrypt = require('bcryptjs')

// access-development-5131c03c-a982-4505-b4ba-6a657ec7ce1b
// access-development-a9627e42-5736-4e8c-8ca9-cfe6245e6419
          ...
          return Token.create({
            ...
            .then((createdtoken) => {
              ...
              let mailOptions = {
                ...
                html: '<p>Click <a href="http://localhost:1337/reset/' + tokenCode + '">here</a> to reset your password</p>' // html body
              };
